            ...
            <div className="max-w-5xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-400 mt-3 text-lg max-w-xl mx-auto">
                        My career path and key technical contributions across
                        different roles.
                    </p>
                </motion.div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className="bg-gray-900/90 border border-gray-800 hover:border-red-500/80 transition-all duration-300 rounded-2xl p-6 sm:p-7 shadow-xl hover:shadow-2xl hover:shadow-red-950/20 group ">
