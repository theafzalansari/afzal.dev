...
const experiences = [
    {
        ...
        description: "Selected for VOIS & Vodafone Idea Foundation program. Building skills in Python, data analysis, visualization, and solving real-world problems through hands-on projects.",
    },
    {
      role: "Founder & Director – Strategy & Technology",
        company: "Food Fed Foundation",
        duration: "Aug 2026 - Present",
        description: "Driving vision and digital platform development to tackle food waste and hunger. Leading team coordination and leveraging technology for social impact.",
    },
];
function ExperienceItem({exp, idx, start, end, scrollYProgress, layout}){
    ...
    if(layout === "desktop"){
        return(
            <div className="relative flex flex-1 justify-center items-center min-w-0">
                ...
                <motion.article className={`absolute ${idx%2 === 0 ? "bottom-12" : "top-12"} bg-gray-900/80 backdrop-blur border 
                border-gray-700/70 rounded-xl p-7 w-[320px] shadow-lg `}
    ...
    return(
        <div className="relative flex items-start">
            <motion.div className="absolute -left-[14px] top-3 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,255,0.1)]"
            style={{scale, opacity}}
            >
                        ...
                        {!isMobile && (
                            <div className="relative w-full max-w-7xl ">
                                <div className="relative h-[6px] bg-white/15 rounded">
                                    <motion.div className="absolute left-0 top-0 h-[6px] bg-red-500 rounded origin-left"
