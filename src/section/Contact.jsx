                ...
                >
                    ...
                    >
                            ...
                            <textarea
                                ...
                                className={`p-3 rounded-md bg-white/10 border ${
                                    errors.message
                                        ? "border-red-500"
                                        : "border-gray-500"
                                } text-white focus:outline-none focus:border-red-500 resize-none`}
                            />
                        ...
                        <motion.button
                            ...
                            type="submit"
                            className="bg-red-500 hover:bg-red-600 disabled:opacity-60 text-white py-3 rounded-md font-semibold transition"
                        >
                            {status === "sending"
                                ? "Sending..."
                                : "Send Message"}
