...
const socials = [
    {Icon: FaLinkedinIn, label: "LinkedIn", href:"https://www.linkedin.com/in/theafzalansari/"},
    {Icon: FaGithub, label: "Github", href:"https://github.com/theafzalansari"},
    {Icon : FaXTwitter, label : "X", href:"https://x.com/theafzalansari?t=uI1zGCYMTkXfjfM47WhCow&s=09"},
    {Icon: FaInstagram, label: "Instagram", href:"https://www.instagram.com/theafzalansarii?igsh=MXRkdTI2dmc3Zjh4MA=="},
]
const glowVariants = {
    initial : {scale:1, y:0, filter:"drop-shadow(0 0 0 rgba(0,0,0,0))"},
    hover: {
        scale:1.2, y:-3,
        filter:"drop-shadow(0 0 8px rgba(239,68,68,0.9)) drop-shadow(0 0 18px rgba(239,68,68,0.5))",
        ...
        <section
            ...
            <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
                <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
                    <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
                        ...
                        >
                            ...
                            <span className="inline-block w-[2px] ml-1 bg-red-500 animate-pulse align-middle"
                            style={{height:"1em"}}
                            >
                            </span>
                        </motion.div>
                ...
                <div className="relative hidden lg:block">
                    ...
                    <motion.img src={avator} alt="Afzal Ansari"
